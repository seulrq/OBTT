...
# for pre-training
def MAE_YaTC(img_size,**kwargs):
    model = MaskedAutoencoder(
        img_size = img_size, patch_size=2, embed_dim=192, depth=4, num_heads=16,
        decoder_embed_dim=128, decoder_depth=2, decoder_num_heads=16,
...
# for fine-tuning
def TraFormer_YaTC(img_size,**kwargs):
    model = TrafficTransformer(
        img_size=img_size, patch_size=2, in_chans=1, embed_dim=192, depth=4, num_heads=16, mlp_ratio=4, qkv_bias=True,
